...
private final static Pattern CHARSET_PATTERN = Pattern.compile("charset=\\S*");
     ...
     * @return html页面信息
     */
    public  static String getData(String linkUrl, SchoolConfigProperties schoolConfigProperties){
        URL url = null;
...
//            httpUrlConnection.setRequestProperty("Accept-Encoding", "gzip, deflate");
    ...
    public static void main(String[] args) {
        ...
        String data = getData(linkUrl, schoolConfigProperties);
